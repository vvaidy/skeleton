 ...
 *   The form state.
 */
function skl8_form_system_theme_settings_alter(&$form, &$form_state) {
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_state'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_state', 'skl8'),
  );
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_switchwidth'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_switchwidth', 'skl8'),
  );
  ...
  $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_topoptiontext'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_topoptiontext', 'skl8'),
  );
